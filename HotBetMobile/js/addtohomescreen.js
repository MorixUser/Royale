...
// message in all supported languages
    ath.intl = {
        ...
        tr_tr: {
            message: 'Sýk kullanýlanlara eklemek için buraya %icon týklamalýsýnýz<strong>%action</strong>.',
            action: {ios: 'Ana Ekrana Ekle', android: 'Ana Ekrana Ekle', windows: 'Ana Ekrana Ekle'}
        }
    };
...
// default options
    ath.defaults = {
        ...
        fontSize: 10,				// base font size, used to properly resize the popup based on viewport scale factor
...
// falls back to en_us if language is unsupported
    ...
    ath.Class.prototype = {
        ...
        show: function (force) {
            ...
            // add the action icon
            message = '<p>' + message.replace('%icon', '<span class="ath-action-icon" style="text-indent: initial;">&nbsp;</span>') + '</p>';
