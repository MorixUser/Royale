				        ...
				        if (data.success == true) {
					        ...
					        $http
						        ...
						        .success(function (data) {
						            ...
						            $rootScope.userSettings.lastip = data.lastip;
						            $rootScope.userSettings.lastlogin = data.lastlogin;
						            $rootScope.userSettings.firstname = data.firstname;
						            $rootScope.userSettings.lastname = data.lastname;
